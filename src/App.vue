        ...
        detail: [
            {
                ...
                notSort: true,
                descArr: [
                    '负责全球APK（手机，电视，手表）主题快应用小游戏相关的审核能力开发，提升全链路审核效率和质量',
                ]
            },
            {
                detailTitle: '技术选型',
...

    {
        ...
        detail: [
            ...
            },
            {
                ...
                notSort: true,
                descArr: [
                    'Vue3x + Vite + Vant + VueX + Element-Plus等',
                ]
            },
            {
                detailTitle: '主要工作',
